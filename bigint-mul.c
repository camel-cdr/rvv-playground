 ...
 *     gmp:     0.0019   0.0054   0.0190   0.0607   0.1902   0.5963 secs
 *     ref:     0.0020   0.0068   0.0242   0.0985   0.4355   1.5029 secs
 *     sketch1: 0.0027   0.0080   0.0295   0.1121   0.4564   1.8003 secs
 *     sketch2: 0.0022   0.0065   0.0236   0.0897   0.3536   1.3695 secs
 *     sketch3: 0.0019   0.0061   0.0221   0.0869   0.3552   1.3681 secs
 *     rvv:     0.0020   0.0052   0.0175   0.0818   0.3680   1.4631 secs
 *     rbr:     0.0130   0.0331   0.1065   0.3829   1.4011   5.3560 secs
 *     vmacc52: 0.0029   0.0089   0.0206   0.0608   0.2364   0.9162 secs
 *     vmacc54: 0.0024   0.0084   0.0205   0.0592   0.2305   0.8251 secs
 *     vmacc56: 0.0025   0.0084   0.0196   0.0562   0.2216   0.7983 secs
 * Note: On this CPU scalar and RVV have the same peak 64-bit mul throughput.
 *       It can do one mul every cycle, and one vmul in four cycles (VLEN=256).
 *
 * SpacemiT A100 N=1024*32 REP=1024*32:
 *     bits:    256      512      1024     2048     4096     8192
 *     gmp:     0.0359   0.0892   0.2675   0.7945   2.4456   7.8208 secs
 *     ref:     0.0328   0.0930   0.2909   1.0216   3.8072  14.7204 secs
 *     sketch1: 0.0528   0.1589   0.5164   1.8594   7.0044  27.2323 secs
 *     sketch2: 0.0333   0.0919   0.2953   1.0587   4.0091  15.6933 secs
 *     sketch3: 0.0343   0.1078   0.3922   1.5127   5.9507  23.6448 secs
 *     rvv:     0.0109   0.0190   0.0351   0.0954   0.2779   2.4605 secs
 *     rbr:     0.0526   0.0983   0.2623   0.7064   2.3352   8.6735 secs
 *     vmacc52: 0.0148   0.0238   0.0400   0.1370   0.4082   1.3716 secs
 *     vmacc54: 0.0127   0.0215   0.0398   0.1330   0.3976   1.3299 secs
 *     vmacc56: 0.0128   0.0220   0.0380   0.1266   0.3817   1.2924 secs
 * Note: On this CPU scalar and RVV have the same peak 64-bit mul throughput.
 *       It can do one mul every cycle, and one vmul in 16 cycles (VLEN=1024).
 *
 * SpacemiT X60 N=1024*32 REP=1024*32:
 *     bits:    256      512      1024     2048     4096     8192
 *     gmp:     0.0069   0.0210   0.0747   0.2327   0.7152   2.2302 secs
 *     ref:     0.0081   0.0266   0.0993   0.3861   1.5267   6.0992 secs
 *     sketch1: 0.0125   0.0440   0.1684   0.6608   2.6218  10.4703 secs
 *     sketch2: 0.0102   0.0348   0.1315   0.5134   2.0332   8.1177 secs
 *     sketch3: 0.0094   0.0326   0.1245   0.4890   1.9426   7.7660 secs
 *     rvv:     0.0040   0.0097   0.0309   0.1367   0.7356   2.9149 secs
 *     rbr:     0.0218   0.0569   0.1740   0.6134   2.2648   8.7086 secs
 *     vmacc52: 0.0047   0.0149   0.0336   0.0944   0.3638   1.4050 secs
 *     vmacc54: 0.0041   0.0139   0.0336   0.0920   0.3546   1.2609 secs
 *     vmacc56: 0.0041   0.0139   0.0320   0.0874   0.3414   1.2195 secs
 * Note: On this CPU scalar and RVV have the same peak 64-bit mul throughput.
 *       It can do one mul every cycle, and one vmul in four cycles (VLEN=256).
 *
 */
...
main(void)
{
	...
	for (size_t i = 0; i < sizeof(cases) / sizeof *cases; ++i) {
		...
		bench("vmacc54", mul_vmaccN, (n*64+63)/54);
		bench("vmacc56", mul_vmaccN, (n*64+63)/56);
#endif
	}
}
#endif
